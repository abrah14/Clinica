    ...
    <div class="row justify-content-center text-center mt-5">
        <div class="card-center">
            <div class="card" style="width: 20rem;">
                <div class="card-body">
                    <form name='login' method='post' action="cadastra-profissional.php">
                        <div class="form-group">
                            <div class="form-row mt-14">
                                <div class=" mb-3">
                                    <label for="validationDefault01"><b>ÁREA RESTRITA</b></label><br>
                                    <label for="validationDefault01"><b>CADASTRO DO PROFISSIONAL</b></label><br>
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control" id="txtNomeProfissional" name="txtNomeProfissional" placeholder="Digite seu Nome...">
                                            </div>
                                            <div class="form-group col-md">
                                                <label for="inputcpf">CPF</label>
                                                <input type="text" class="form-control" id="txtCpfProfissional" name="txtCpfProfissional" placeholder="Digite seu CPF...">
                                            </div>
                                        </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputAddress">RG</label>
                                    <input type="text" class="form-control" id="txtRgProfissional" name="txtRgProfissional" placeholder="Digite seu RG...">
                                </div>
                                <div class="form-row">
                                    <div class="form-row">
                                        <br>
                                        <button type="submit" class="btn btn-secondary" href='cadastra-profissional.php'>Cadastrar</button>
