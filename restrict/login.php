                    ...
                    <form name='login' method='post' action="valida-acesso.php">
                        <div class="form-group">
                            <div class="form-row mt-10">
                                <div class=" mb-3">
                                    <label for="validationDefault01"><b>Login:</b></label>
                                    <input type="text" name='txtLogin' id='txtLogin' class="form-control" placeholder="Nome...">
                                </div>
                                <div class=" mb-3">
                                    <label for="validationDefault02"><b>Senha:</b></label>
                                    <input type="password" class="form-control" type='password' name='txtSenha' id='txtSenha' placeholder="Senha...">
                                </div>
                            </div>
