                        ...
                        <form name='login' method='post' action="valida-acesso.php">
                            <div class="form-group">
                                <div class="form-row mt-10">
                                    <div class=" mb-3">
                                        <label for="validationDefault01" class="mb-2"><b>Escolha sua área de cadastro:</b></label>
                                        <a class="btn btn-secondary" href="form-paciente.php" role="button">Paciente</a>
                                        <a class="btn btn-secondary" href="form-profissional.php" role="button">Profissional</a>
                                    </div>
                                </div>
                        </form>
                    </div>
